...
\begin{figure}[h!]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.25\textheight]{./images/ip_sem_img_1.png}}
...
\begin{figure}[h!]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.5\textheight]{./images/ip_sem_img_3.png}}
...
% TODO: slika Apriori(5) i Carma(6)
 ...
 \begin{figure}[!h]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.45\textheight]{./images/5_rezultati_apriori.PNG}}
 \caption{Apriori}
\end{figure}

\begin{figure}[!h]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.45\textheight]{./images/6_rezultati_carma.PNG}}
 \caption{Carma}
\end{figure}
...
\begin{figure}[!h]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.2\textheight]{./images/stream1_apriori_bal_osvetljenje.PNG}}
...
\begin{figure}[h!]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.4\textheight]{./images/stream1_apriori_red_sudar.PNG}}
...
\begin{figure}[!h]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.3\textheight]{./images/stream1_apriori_vrsta_sudara.PNG}}
...
\begin{figure}[h!]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.4\textheight]{./images/stream1_model.PNG}}
...
\begin{figure}[h!]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.5\textheight]{./images/places_carma.PNG}}
...
\begin{figure}[h!]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.4\textheight]{./images/jovanov_izbor_apriori.PNG}}
...
\begin{figure}[h!]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.3\textheight]{./images/izbor5_apriori.PNG}}
...
\begin{figure}[h!]
 \centering
 \makebox[\textwidth][c]{\includegraphics[width=1\textwidth,height=0.3\textheight]{./images/izbor5_carma.PNG}}
